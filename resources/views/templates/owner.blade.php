...
<ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion toggled" id="accordionSidebar">
    ...
    <li class="nav-item " data-value="Laporan">
        <a class="nav-link collapsed" href="{{url('/owner/laporan')}}"  >
            <i class="fas fa-fw fa-cog"></i>
            <span>Laporan</span>
        </a>
    </li><li class="nav-item " data-value="Pendapatan Kotor">
      <a class="nav-link collapsed" href="{{url('/owner/pendapatan')}}"  >
          <i class="fas fa-fw fa-cog"></i>
